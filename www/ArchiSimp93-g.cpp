...
const int deltaT=1;          /* Pas de temps, en jours optimaux */
...
{
  FSeg=fopen("seg.txt","w");    // Fichier contenant les segments
...
{   /* Tire le diam?tre d'un m?rist?me de ramification suivant celui du p?re
	...
	while (diamPFille>(0.95*axePere->pointe->diametre)) diamPFille=tireGaussien(moy,et);
